...
const UI_ASSET_PATHS = [
  ...
  'assets/ui/btn_start.png', 'assets/ui/levels_screen.jpg',
...
function renderLevelSelect() {
  ...
  // This build uses the full-screen levels artwork with hotspot buttons, so
  // there may be no #level-list element. In that case the page is already
  // rendered by index.html; do not throw an error.
  if (!list) return;
  list.innerHTML = '';
